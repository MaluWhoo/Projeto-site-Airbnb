...
// Rota dinâmica - [id] - para capturar o id da acomodação
// params - objeto que contém os parâmetros da rota

// slug -  É uma parte da URL que identifica uma página específica de forma legível e amigável, geralmente usada para SEO.
...
export default async function Page(
    ...
    // Simulando uma chamada para buscar os dados da acomodação pelo id
